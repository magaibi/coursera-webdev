...
// - The program should:
//   1.  say "Hello" to any name except names that start with a "J" or "j",
//   2. otherwise, the program should say "Good Bye".
...
for (var i = 0; i < names.length; i++) {
  ...
  if (firstLetter === 'j') {
    byeSpeaker.speak(names[i]);
		// Below has been commented out for a clean/neat output
